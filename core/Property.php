<?php
	...
	*/
	...
	class Property
	{
		...
		public $Taghandling = 0;
		public $Onlinepay = false;
		public $Selfcheckin = false;
		...
		function __construct($arg=null)
		{
			if($arg != null)
			{
				...
				if($res->num_rows > 0)
				{
					...
					$this->Selfcheckin = Convert::ToBool($row['selfcheckin']);
					$this->Onlinepay = Convert::ToBool($row['onlinepay']);
		...
		public function Save()
		{
			...
			$selfcheckin = Convert::ToInt($this->Selfcheckin);
		...
		public static function Search($term='')
		{
			...
			while(($row = $res->fetch_assoc()) != null)
			{
                ...
                $ret[$i]->Selfcheckin = Convert::ToBool($row['selfcheckin']);
        ...
        public static function ByMeta($meta)
        {
            ...
            if($res->num_rows > 0)
            {
                ...
                $ret->Selfcheckin = Convert::ToBool($row['selfcheckin']);
                $ret->Onlinepay = Convert::ToBool($row['onlinepay']);
                $ret->Taghandling = Convert::ToInt($row['taghanding']);

                $ret->Rooms = Room::RoomCount(new Subscriber($ret->Databasename, $ret->DatabaseUser, $ret->DatabasePassword));
                $ret->Reservations = Reservation::ReservationCount($ret);
            }
            return $ret;
        }
