	...
	*/
	...
	class EventListener
	{
		...
		public static function Filter(Subscriber $subscriber, $term='', $field='eventlistenerid')
		{
			...
			$res = $db->query("SELECT * FROM eventlistener WHERE ".$field." ='$term' AND propertyid = '$propertyid'");
			while(($row = $res->fetch_assoc()) != null)
			{
                $ret[$i] = new Eventlistener($subscriber);
                $ret[$i]->Id = $row['eventlistenerid'];
		...
		public static function Order(Subscriber $subscriber, $field='id', $order='DESC')
		{
			...
			$res = $db->query("SELECT * FROM eventlistener WHERE propertyid = '$propertyid' ORDER BY ".$field." ".$order."");
			while(($row = $res->fetch_assoc()) != null)
			{
                $ret[$i] = new Eventlistener($subscriber);
                $ret[$i]->Id = $row['eventlistenerid'];
		...
		public static function All(Subscriber $subscriber)
		{
			...
			$res = $db->query("SELECT * FROM eventlistener WHERE propertyid = '$propertyid'");
			while(($row = $res->fetch_assoc()) != null)
			{
				$ret[$i] = new Eventlistener($subscriber);
				$ret[$i]->Id = $row['eventlistenerid'];
		...
		public static function SystemEvents(Subscriber $subscriber)
		{
			...
			$res = $db->query("SELECT * FROM eventlistener WHERE issystem=1 AND propertyid = '$propertyid'");
			while(($row = $res->fetch_assoc()) != null)
			{
				$ret[$i] = new Eventlistener($subscriber);
				$ret[$i]->Id = $row['eventlistenerid'];
		...
		public static function UserEvents(Subscriber $subscriber)
		{
			...
			$res = $db->query("SELECT * FROM eventlistener WHERE issystem=0 AND propertyid = '$propertyid'");
			while(($row = $res->fetch_assoc()) != null)
			{
				$ret[$i] = new Eventlistener($subscriber);
				$ret[$i]->Id = $row['eventlistenerid'];
