<?php
	...
	*/
	...
	class Role
	{
		...
		{
            $this->Booking = new Access();
            $this->Discount = new Access();
            $this->Customers = new Access();
            $this->Staff = new Access();
            $this->Rooms = new Access();
            $this->Kitchen = new Access();
            $this->Bakery = new Access();
            $this->Bar = new Access();
            $this->Laundry = new Access();
            $this->Housekeeping = new Access();
            $this->Pool = new Access();
            $this->Store = new Access();
            $this->Event = new Access();
            $this->Finance = new Access();
            $this->Branch = new Access();
            $this->Log = new Access();
            $this->Report = new Access();
            $this->Messaging = new Access();
            $this->Webfront = new Access();
            $this->Webconfig = new Access();
            $this->Settings = new Access();
            $this->Name = "";
            ...
            $this->Frontdesk = new Access();
            $this->Kitchenpos = new Access();
            $this->Laundrypos = new Access();
            $this->Bakerypos = new Access();
            $this->Poolpos = new Access();
            $this->Barpos = new Access();
		...
		public static function ByProperty($property, $term='')
		{
			$db = DB::GetDB();
			$ret = array();
			$i = 0;
